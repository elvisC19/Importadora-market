      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          ...
          <div 
            ...
            className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-5 cursor-pointer hover:shadow-md hover:border-red-200 transition-all group"
          >
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="p-6 border-b border-gray-100 bg-slate-50/50 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                      ...
                      <tr key={order.id} className="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-right">
                          <button
                            ...
                            className="inline-flex items-center justify-center gap-1.5 px-4.5 py-2 bg-slate-100 hover:bg-primary hover:text-white text-primary text-xs font-bold rounded-xl transition-all"
                          >
